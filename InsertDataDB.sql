...
Insert into Pays (IdPays, LastNamePays, Drapeau) values (1, 'France', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (2, 'Japon', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (3, 'Espagne', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (4, 'Italie', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (5, 'Canada', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (6, 'Allemagne', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (7, 'Russie', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (8, 'Chine', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (9, 'Corée', null);
Insert into Pays (IdPays, LastNamePays, Drapeau) values (10, 'Royaume-Uni', null);
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (3, 'ggori2', 'nGRB0y', 'ggori2@163.com', 'Giulio', 'Gori', 'Rizal', 'In congue. Etiam justo. Etiam pretium iaculis justo.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (5, 'bmckendry4', 'q3HiMdZp', 'bmckendry4@goodreads.com', 'Berna', 'McKendry', 'Guolemude', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (7, 'wrubens6', 'hArOOj', 'wrubens6@economist.com', 'Wilfrid', 'Rubens', 'Nisporeni', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', null, 9, 6, '2/17/2022');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (9, 'hdewerk8', 'K4S11aWmKiSj', 'hdewerk8@yandex.ru', 'Hercule', 'de Werk', 'Chư Prông', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', null, 3, 2, '3/5/2022');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (12, 'wrobbekeb', 'RgTFuhSN', 'wrobbekeb@nydailynews.com', 'Ware', 'Robbeke', 'Strängnäs', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.', null, 9, 6, '12/14/2021');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (15, 'bstuddee', 'Q7Fqscs0BwP', 'bstuddee@sun.com', 'Bel', 'Studde', 'Pskov', 'Fusce consequat. Nulla nisl. Nunc nisl.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (16, 'gestcourtf', 'EIVG64kV', 'gestcourtf@bluehost.com', 'Gerhard', 'Estcourt', 'Timon', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (17, 'fduleng', 'rimStC5P', 'fduleng@unc.edu', 'Fleming', 'Dulen', 'Livadiya', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (18, 'gbalchh', 'oaTOoDUX', 'gbalchh@tripod.com', 'Griffie', 'Balch', 'Choya', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (19, 'wambrozi', 'jaNjDkQx', 'wambrozi@homestead.com', 'Winni', 'Ambroz', 'Sukaraja', 'Phasellus in felis. Donec semper sapien a libero. Nam dui.', null, 9, 2, '4/11/2021');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (25, 'ecuttelaro', 'Tajha27bm0a', 'ecuttelaro@blogs.com', 'Emmit', 'Cuttelar', 'Sarāb', 'Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (29, 'dbarretts', 'l9dW0O2vBpxI', 'dbarretts@mysql.com', 'Donelle', 'Barrett', 'Sosnovka', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (30, 'qselburnt', 'EVDoesK', 'qselburnt@apple.com', 'Quinn', 'Selburn', 'Shanggu', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (33, 'ugarmsw', 'JZspDlZkiF', 'ugarmsw@cbsnews.com', 'Ulises', 'Garms', 'Waepana', 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (36, 'scrosslandz', '8GH3KgCwiZ8T', 'scrosslandz@digg.com', 'Silvano', 'Crossland', 'Subotica', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (37, 'vjowers10', 'QuKiOy4UBYoz', 'vjowers10@wp.com', 'Vinny', 'Jowers', 'Laascaanood', 'In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (39, 'yfarherty12', 'ZfiD0BNWnst', 'yfarherty12@sun.com', 'Yoshiko', 'Farherty', 'Longhua', 'Fusce consequat. Nulla nisl. Nunc nisl.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (40, 'mmottershead13', 'fLCJFsS', 'mmottershead13@adobe.com', 'Myrah', 'Mottershead', 'Bulungu', 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (41, 'dcallar14', '9lSXhvR', 'dcallar14@prweb.com', 'Dougie', 'Callar', 'Lamont', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (42, 'bmccerery15', 'zVYqHnM', 'bmccerery15@bluehost.com', 'Brigit', 'McCerery', 'Fengshuling', 'Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (45, 'nkeam18', 'OagxQ3eIbwlM', 'nkeam18@thetimes.co.uk', 'Natal', 'Keam', 'La Tebaida', 'Fusce consequat. Nulla nisl. Nunc nisl.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (46, 'ghelder19', 'faz0Q0hBa', 'ghelder19@timesonline.co.uk', 'Glyn', 'Helder', 'Arnhem', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.', null, 8, 9, '9/7/2021');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (47, 'ccroft1a', '5oSr2O', 'ccroft1a@pinterest.com', 'Clint', 'Croft', 'Clarin', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (56, 'tredit1j', 'pwXmyW7R', 'tredit1j@i2i.jp', 'Tish', 'Redit', 'Yinglan', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (57, 'twinchcum1k', 'mv36eyI', 'twinchcum1k@webeden.co.uk', 'Tait', 'Winchcum', 'Daya', 'Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (62, 'lcolvie1p', 'txQIBdMKlG', 'lcolvie1p@usnews.com', 'Lonnie', 'Colvie', 'Naryn', 'Fusce consequat. Nulla nisl. Nunc nisl.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (65, 'tmelbourne1s', '0L7BtKX', 'tmelbourne1s@taobao.com', 'Tybie', 'Melbourne', 'Féres', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (66, 'eshear1t', 'RqMQUQMFDk', 'eshear1t@wsj.com', 'Eal', 'Shear', 'Chyšky', 'In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (69, 'kdowson1w', 'NlZikRi9xU', 'kdowson1w@europa.eu', 'Katrina', 'Dowson', 'Cihua', 'Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (70, 'atreacher1x', 'gymccce', 'atreacher1x@themeforest.net', 'Amble', 'Treacher', 'Engenho', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (71, 'blufkin1y', 'zzINvqdyCp', 'blufkin1y@adobe.com', 'Bart', 'Lufkin', 'Farsta', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (73, 'crobiot20', '5DI6UBp', 'crobiot20@mac.com', 'Candice', 'Robiot', 'Marugame', 'Phasellus in felis. Donec semper sapien a libero. Nam dui.', null, 4, 9, '5/21/2021');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (74, 'bbolt21', 'Po2AhvXbCm', 'bbolt21@cisco.com', 'Bordy', 'Bolt', 'Liuzhi', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', null, 4, 9, '10/1/2021');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (76, 'cplaskitt23', 'YvHD1HuI', 'cplaskitt23@privacy.gov.au', 'Cindy', 'Plaskitt', 'Ensanche Luperón', 'Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (77, 'nstrong24', 'QGmGlRfU', 'nstrong24@canalblog.com', 'Nalani', 'Strong', 'Yamaga', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (79, 'kthying26', 'jx9VI8dh', 'kthying26@icq.com', 'Kathy', 'Thying', 'Nāḩiyat as Sab‘ Biyār', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (81, 'jmattheus28', '2N0X3G9GZ9', 'jmattheus28@canalblog.com', 'Jenelle', 'Mattheus', 'Linjiang', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (83, 'drandales2a', 'jEj0OnWzXQ', 'drandales2a@mozilla.com', 'Decca', 'Randales', 'Gjirokastër', 'Ut at dolor quis odio consequat varius.', null, 9, 1, '2021-02-24');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (87, 'cbeardsall2e', '1i50WRbtp', 'cbeardsall2e@youtu.be', 'Constancy', 'Beardsall', 'Buga', 'Vestibulum ac est lacinia nisi venenatis tristique.', null, 2, 4, '2020-10-29');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (89, 'ubroszkiewicz2g', 'qdFrqp2fyQ', 'ubroszkiewicz2g@nasa.gov', 'Ursula', 'Broszkiewicz', 'Stamford', 'Integer ac neque.', null, 4, 3, '2020-11-14');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (105, 'bdickey2w', 'kCLU1lgJ', 'bdickey2w@apple.com', 'Betteann', 'Dickey', 'Anyar', 'Ut at dolor quis odio consequat varius. Integer ac leo.', null, 4, 3, '2020-08-15');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (107, 'jmonson2y', 'Zv2HiTKSi8', 'jmonson2y@diigo.com', 'Jobi', 'Monson', 'Néa Karváli', 'Ut tellus. Nulla ut erat id mauris vulputate elementum.', null, 10, 5, '2021-01-23');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (111, 'lpach32', 'gq7Azd2v', 'lpach32@people.com.cn', 'Lee', 'Pach', 'Malhiao', 'In blandit ultrices enim.', null, 5, 8, '2021-05-27');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (116, 'itander37', 'XN1bVOQPi2T', 'itander37@theatlantic.com', 'Inness', 'Tander', 'Słupsk', 'Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo.', null, 10, 3, '2020-06-12');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (117, 'tgovini38', 'jvPF3gu', 'tgovini38@indiegogo.com', 'Trev', 'Govini', 'Hwasun', 'Sed sagittis.', null, 8, 10, '2020-10-05');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (119, 'lsword3a', 'N9eeQk', 'lsword3a@yandex.ru', 'Lucretia', 'Sword', 'Ilesa', 'Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.', null, 4, 10, '2020-11-19');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (121, 'jjorry3c', 'yabHfNpJTYKi', 'jjorry3c@nyu.edu', 'Jozef', 'Jorry', 'Zdounky', 'Vestibulum sed magna at nunc commodo placerat.', null, 4, 1, '2021-07-08');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (122, 'dharryman3d', 'bZQF57YnGwUE', 'dharryman3d@house.gov', 'Dominique', 'Harryman', 'Çalxanqala', 'Morbi ut odio.', null, 4, 5, '2021-03-31');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (125, 'akenealy3g', 'vtfQDipuu', 'akenealy3g@hhs.gov', 'Andria', 'Kenealy', 'São Mateus', 'Ut at dolor quis odio consequat varius. Integer ac leo.', null, 5, 9, '2020-10-12');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (128, 'atrumper3j', 'pBaNWNRsm', 'atrumper3j@weebly.com', 'Arabel', 'Trumper', 'Naranjito', 'In blandit ultrices enim.', null, 1, 3, '2021-06-08');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (131, 'jgoodings3m', '28F5srmR', 'jgoodings3m@nba.com', 'Jarad', 'Goodings', 'Wuṯahpūr', 'Morbi ut odio.', null, 8, 4, '2020-10-13');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (132, 'kgrahamslaw3n', 'JtvQ2DB', 'kgrahamslaw3n@xrea.com', 'Kari', 'Grahamslaw', 'Angao', 'Phasellus in felis. Donec semper sapien a libero.', null, 5, 4, '2020-10-06');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (133, 'fchilders3o', 'LqsyLO', 'fchilders3o@artisteer.com', 'Flossi', 'Childers', 'Lyuban’', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', null, 4, 2, '2021-06-22');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (134, 'gglencross3p', 'IhmVJl', 'gglencross3p@soundcloud.com', 'Garth', 'Glencross', 'Mlonggo', 'Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl.', null, 2, 4, '2020-12-27');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (139, 'mmosco3u', 'Ljuy77Nl', 'mmosco3u@techcrunch.com', 'Myranda', 'Mosco', 'Woodford Hill', 'Etiam vel augue. Vestibulum rutrum rutrum neque.', null, 9, 4, '2020-12-20');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (140, 'phardes3v', 'KCbY0rqPryhW', 'phardes3v@privacy.gov.au', 'Patton', 'Hardes', 'Zhangshui', 'Suspendisse accumsan tortor quis turpis.', null, 7, 1, '2020-11-17');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (141, 'twolseley3w', 'WwMAAb', 'twolseley3w@globo.com', 'Tarrah', 'Wolseley', 'Žamberk', 'In hac habitasse platea dictumst. Etiam faucibus cursus urna.', null, 1, 3, '2020-07-23');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (146, 'nbrockwell41', 'WhZ8N4xWTv', 'nbrockwell41@sfgate.com', 'Nat', 'Brockwell', 'Babakan Baru', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', null, 2, 1, '2020-08-30');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (155, 'gplester4a', 'rNUSCv98BebS', 'gplester4a@yahoo.co.jp', 'Garrik', 'Plester', 'Touama', 'Quisque id justo sit amet sapien dignissim vestibulum.', null, 10, 9, '2021-04-15');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (159, 'tmarcroft4e', 'kR6NpxUT5yQO', 'tmarcroft4e@ihg.com', 'Travers', 'Marcroft', 'Cergy-Pontoise', 'Duis ac nibh.', null, 3, 6, '2020-07-13');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (161, 'bgarrit4g', 'hligsg9h', 'bgarrit4g@telegraph.co.uk', 'Britney', 'Garrit', 'Puente Alto', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros.', null, 7, 2, '2021-06-13');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (162, 'dduffell4h', 'hg7v8IToBU', 'dduffell4h@mtv.com', 'Darb', 'Duffell', 'Curahklapa', 'Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla.', null, 2, 2, '2021-03-06');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (166, 'aaizikovich4l', '5pmVTJ', 'aaizikovich4l@about.me', 'Anna-diana', 'Aizikovich', 'Meixi', 'Proin at turpis a pede posuere nonummy.', null, 6, 1, '2021-04-29');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (168, 'rlakin4n', 'HvXOPCsQ3O', 'rlakin4n@mail.ru', 'Rich', 'Lakin', 'Liuduzhai', 'Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl.', null, 1, 6, '2020-12-11');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (172, 'tjenken4r', 'c3tVHPx', 'tjenken4r@patch.com', 'Torrin', 'Jenken', 'Yihe', 'Quisque ut erat. Curabitur gravida nisi at nibh. In hac habitasse platea dictumst.', null, 5, 5, '2020-07-09');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (178, 'rlymer4x', 'X5jcw1oWEW', 'rlymer4x@eventbrite.com', 'Rodd', 'Lymer', 'Chadian', 'Mauris sit amet eros. Suspendisse accumsan tortor quis turpis. Sed ante.', null, 2, 1, '2020-08-27');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (180, 'tpaish4z', 'SjAHIvRFMmNA', 'tpaish4z@yolasite.com', 'Teri', 'Paish', 'Saint-Brieuc', 'Morbi ut odio.', null, 3, 5, '2021-03-17');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (182, 'bcongreve51', 'x3iMxM', 'bcongreve51@youtu.be', 'Barri', 'Congreve', 'Shuangxing', 'Nulla tellus. In sagittis dui vel nisl. Duis ac nibh.', null, 10, 3, '2020-09-15');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (185, 'cgatch54', 'c5ANWYXpZOhf', 'cgatch54@time.com', 'Christy', 'Gatch', 'Klyetsk', 'Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.', null, 4, 8, '2020-12-12');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (187, 'ccassley56', '68sW9A2', 'ccassley56@blogspot.com', 'Correy', 'Cassley', 'Golovchino', 'Etiam vel augue. Vestibulum rutrum rutrum neque.', null, 2, 1, '2020-10-14');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (190, 'bgiacaponi59', 'jNn2ZBiT0x', 'bgiacaponi59@tripadvisor.com', 'Bard', 'Giacaponi', 'Néa Éfesos', 'Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo.', null, 5, 8, '2020-07-22');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (202, 'ctomovic5l', '1BQ6GaGTNKz', 'ctomovic5l@abc.net.au', 'Cullie', 'Tomovic', 'Nuasepu', 'Nulla ut erat id mauris vulputate elementum.', null, 4, 4, '2020-10-12');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (208, 'kpitcaithly5r', '3mpAASv', 'kpitcaithly5r@over-blog.com', 'Kerry', 'Pitcaithly', 'Yanaoca', 'Donec quis orci eget orci vehicula condimentum.', null, 8, 3, '2021-07-12');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (209, 'hbreens5s', '0NKUpX', 'hbreens5s@nifty.com', 'Hans', 'Breens', 'Ramos', 'Vivamus in felis eu sapien cursus vestibulum. Proin eu mi.', null, 3, 9, '2021-06-08');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (210, 'esutherland5t', 'z2UbnJC7p', 'esutherland5t@wikimedia.org', 'Emmaline', 'Sutherland', 'Tanjung', 'Etiam vel augue. Vestibulum rutrum rutrum neque.', null, 8, 10, '2020-08-03');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (211, 'espillman5u', 'Nw3u2V', 'espillman5u@va.gov', 'Ezmeralda', 'Spillman', 'Fajã de Cima', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros.', null, 1, 10, '2020-06-16');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (212, 'jwashington5v', 'Tax9sICc2198', 'jwashington5v@devhub.com', 'Jerrold', 'Washington', 'Saseel', 'In eleifend quam a odio.', null, 10, 3, '2020-10-12');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (221, 'iotoole64', 'EPbWqjM4gu', 'iotoole64@oakley.com', 'Ingrid', 'O''Toole', 'Jabon', 'Curabitur at ipsum ac tellus semper interdum.', null, 8, 1, '2021-06-06');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (222, 'bdoughtery65', 'zrXaIq', 'bdoughtery65@foxnews.com', 'Brandon', 'Doughtery', 'Santa Elena', 'Etiam justo.', null, 2, 5, '2021-02-17');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (225, 'rburgwin68', 'b5DTZvCu0', 'rburgwin68@wikimedia.org', 'Rosa', 'Burgwin', 'Kallífytos', 'Sed vel enim sit amet nunc viverra dapibus.', null, 2, 3, '2021-02-02');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (226, 'dmcharg69', 'dH7Weleh2Z', 'dmcharg69@psu.edu', 'Drusi', 'Mc Harg', 'Nice', 'Morbi non quam nec dui luctus rutrum. Nulla tellus.', null, 8, 6, '2021-06-08');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (228, 'negger6b', 'MnE3hWhSg', 'negger6b@so-net.ne.jp', 'Nikolia', 'Egger', 'Władysławowo', 'Suspendisse potenti.', null, 8, 8, '2020-07-20');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (229, 'lmerrigans6c', 'LAyO5b', 'lmerrigans6c@hubpages.com', 'Lock', 'Merrigans', 'Gibara', 'Nunc purus. Phasellus in felis. Donec semper sapien a libero.', null, 8, 5, '2021-03-22');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (231, 'dpoff6e', 'AgdN19ZxJ', 'dpoff6e@digg.com', 'Dayle', 'Poff', 'Mielec', 'Vestibulum sed magna at nunc commodo placerat.', null, 6, 4, '2020-07-03');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (233, 'sturbefield6g', 'g4beP1velD', 'sturbefield6g@yelp.com', 'Shel', 'Turbefield', 'Nanyaojie', 'Proin at turpis a pede posuere nonummy.', null, 5, 9, '2021-01-25');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (234, 'urought6h', 'qQtktbeC3B', 'urought6h@prweb.com', 'Ursulina', 'Rought', 'Bethlehem', 'Aliquam sit amet diam in magna bibendum imperdiet.', null, 2, 7, '2020-08-13');
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (235, 'ndoggart6i', 'YBrL4SWTLwl', 'ndoggart6i@so-net.ne.jp', 'Norine', 'Doggart', 'Cincinnati', 'Curabitur at ipsum ac tellus semper interdum.', null, 9, 3, '2021-06-30');
...
insert into Utilisateur (UserID, Username, Password, Email, FirstName, LastName, Ville, Presentation, Avatar, IdPays, IdGame, DateJoined) values (237, 'bkerrey6k', 'CcwhwY', 'bkerrey6k@unc.edu', 'Brianne', 'Kerrey', 'Chekhov', 'Maecenas pulvinar lobortis est.', null, 4, 6, '2021-03-09');
